...
"
      ...
      <section className="text-center mt-28 relative z-20 max-w-3xl mx-auto px-4">
        <div className="inline-block audiowide-regular px-6 py-2 rounded-full text-sm tracking-wide font-medium text-orange-300 border border-orange-400/30 bg-black/30 backdrop-blur-xl shadow-[0_0_12px_rgba(255,122,0,0.25)]">
          Track • Control • Grow
        </div>

        <h1 className="max-w-3xl text-4xl md:text-5xl audiowide-regular font-bold mt-4 leading-tight">
          Smarter Money Management with{" "}
          <span className="text-orange-500">Monexa</span>
        </h1>

        <p className="text-gray-400 mt-4 text-lg md:text-lg leading-tight">
      ...
      <div className="relative w-full flex justify-center mt-32 mb-10 px-4 z-20">
