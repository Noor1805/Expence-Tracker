...
const DEFAULT_GLOW_COLOR = "255, 102, 0";
      ...
      <style>
        {`
          .bento-section {
            ...
            --white: hsl(0, 0%, 100%);
            --orange-primary: rgba(255, 102, 0, 1);
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(78, 24, 0, 0.4), 0 0 30px rgba(${glowColor}, 0.2);
          }
          ...
          .particle-container:hover {
            box-shadow: 0 4px 20px rgba(78, 24, 0, 0.2), 0 0 30px rgba(${glowColor}, 0.2);
          }
