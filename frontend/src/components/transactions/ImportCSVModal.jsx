  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="glass neo rounded-2xl p-6 w-[420px]" style={{ border: "1px solid rgba(255,255,255,0.05)" }}>
        ...
        <input type="file" accept=".csv" className="text-cyan-400" onChange={e => setFile(e.target.files[0])} />
        <div className="flex justify-end gap-3 mt-4">
          <button onClick={onClose} className="px-4 py-2 text-white rounded-xl bg-white/5">Cancel</button>
